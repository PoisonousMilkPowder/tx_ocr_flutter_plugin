...
- (void)updateOrientation:(UIDeviceOrientation)deviceOrientation withIsHoriz:(BOOL)isHoriz;
...
- (void)sendBestFrame:(NSString *)bestFrame withRoiRectStr:(NSString *)roiRectStr;
- (void)sendTimeOut;
